...
```kotlin
fun main() {
    println("Student 2025003014 says hello")
}
```
...
```kotlin
fun main() {
    println("Hello, my name is chenbangguo")
}
```
...
```kotlin
fun main() {
    println("ID: 2025003014")
    println("Name: chenbangguo")
...
```kotlin
fun main() {
    val chenbangguoDelivery = "2025003014"
    println("Package for " + "chenbangguo" + " will arrive, tracking ID: " + chenbangguoDelivery + ".")
}
```
...
```kotlin
fun main() {
    println(chenbangguoGreeting(age = 4))
    println(chenbangguoGreeting("chenbangguo", 1))
}

fun chenbangguoGreeting(name: String = "2025003014", age: Int): String {
...
```kotlin
fun main() {
    printChenbangguoWeather("Ankara", 27, 31, 82)
    printChenbangguoWeather("Tokyo", 32, 36, 10)
    printChenbangguoWeather("Cape Town", 59, 64, 2)
    printChenbangguoWeather("Guatemala City", 50, 55, 7)
}

fun printChenbangguoWeather(city: String, low: Int, high: Int, rain: Int) {
    println("City: $city")
