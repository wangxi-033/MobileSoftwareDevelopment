...
```kotlin
fun main() {
    println("My name is gemadingzheng")
    println("My student ID is 2025003025")
...
```kotlin
fun main() {
    println("Student 2025003025 says hello")
}
```
...
```kotlin
fun main() {
    printLine("Hello, my name is gemadingzheng")
}
```
...
```kotlin
fun main() {
    println("Hello, my name is gemadingzheng")
}
```
...
```kotlin
fun main() {
    println("ID: 2025003025") 
    println("Name: gemadingzheng") 
...
```kotlin
fun main() {
    val gemadingzhengDelivery = "2025003025" 
    println("Package for gemadingzheng will arrive, tracking ID: " + gemadingzhengDelivery + ".")
}
```
...
```kotlin
fun main() {
    println(gemadingzhengGreeting(age = 5))   
    println(gemadingzhengGreeting("gemadingzheng", 2)) 
}

fun gemadingzhengGreeting(name: String = "2025003025", age: Int): String {
